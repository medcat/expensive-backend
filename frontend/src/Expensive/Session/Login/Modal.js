  ...
  render() {
    return (
      <form className="user-form modal" onSubmit={this.props.onSubmit}>
        ...
        <input className="user-form-input" name="session[email]" type="email"
          placeholder="email" onChange={this.props.onUpdateEmail}
          disabled={this.props.status == "loading"} />
        <input className="user-form-input" name="session[password]"
